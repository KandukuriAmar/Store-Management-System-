...
<center><h1>Add Product</h1></center><br/>
    <form action="adddata" method="post" class="max-w-lg mx-auto bg-white p-8 rounded-lg shadow-md">
        <div class="mb-4">
        ...
        <button type="submit" class="bg-indigo-600 text-white rounded-lg px-4 py-2 hover:bg-indigo-700">Add Product</button>
    </form>
</body>
</html>
